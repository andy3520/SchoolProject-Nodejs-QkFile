...
function sendAjaxUpload() {
  if (passFile)
    ...
    } else $("#errorModal").modal("show"), $("#errorMessage").html("411 - File lớn hơn mức quy định là 50 MB")
}
var uploadField = document.getElementById("chooseFile");
null !== uploadField && (uploadField.onchange = function() {
  const e = $("#chooseFile").val();
  /^\s*$/.test(e) ? changeToYellow() : changeToGreen(e), this.files[0].size > 5e7 ? (this.value = "", passFile = !1) : passFile = !0
